...
///</summary>
void EERAM::begin(const uint8_t A0, const uint8_t A1) {
  //build mask
...
///</summary>
uint8_t EERAM::write(const uint16_t address, const uint8_t value) {
  address16b a;
  a.a16 = address;
...
///</summary>
uint8_t EERAM::read(const uint16_t address) {
  uint8_t buffer;
  address16b a;
  a.a16 = address;
...
///<summary>
/// De/Activate the "AutoStore" to EERAM functionnality of the RAM when power is lost.
///   <param name="value">Set to true to activate, false otherwise</param>
///</summary>
void EERAM::setAutoStore(const bool value)
{
...
///   <returns>0:success, 1:data too long to fit in transmit buffer, 2 : received NACK on transmit of address, 3 : received NACK on transmit of data, 4 : other error </returns>
///</summary>
uint8_t EERAM::write(const uint16_t address, const uint8_t* values, const uint16_t size)
{
  address16b a;
  a.a16 = address;
...
///</summary>
void EERAM::read(const uint16_t address, uint8_t * values, const uint16_t size)
{
  address16b a;
  a.a16 = address;
